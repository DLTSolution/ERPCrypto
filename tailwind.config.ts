  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        "crypto-gradient": "linear-gradient(135deg, hsl(var(--gradient-start)) 0%, hsl(var(--gradient-end)) 100%)",
        "shimmer": "linear-gradient(90deg, transparent 0%, hsl(var(--muted) / 0.3) 50%, transparent 100%)",
      },
    },
  },
